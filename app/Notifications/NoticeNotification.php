...
class NoticeNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        ->subject('নতুন নোটিশ প্রেরণ করেছেন!')
        ->line('নোটিশটি সম্পন্ন পড়তে হলে, স্বাধীন শিক্ষার ড্যাশবোর্ড চেক করুন।')
        ->action('বিস্তারিত জানতে ক্লিক করুন', route('notice.manage'))
