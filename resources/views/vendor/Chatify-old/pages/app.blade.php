        ...
        <div class="m-header m-header-messaging">
            <nav>
                ...
                <div style="display: inline-flex;">
                    ...
                    <a href="#" class="user-name">{{ "Online Trafik 24/7 Messages" }}</a>
                </div>
                {{-- header buttons --}}
                <nav class="m-header-right">
                    <a href="#" class="add-to-favorite"><i class="fas fa-star"></i></a>
                    @if(Auth::user()->is_super == 0)
                    <a href="{{ url('admin/dashboard') }}" class="logo logo-light"><i class="fas fa-home"></i></a>
                    @elseif(Auth::user()->is_super == 1)
                    <a href="{{ url('teacher/dashboard') }}" class="logo logo-light"><i class="fas fa-home"></i></a>
                    @endif
