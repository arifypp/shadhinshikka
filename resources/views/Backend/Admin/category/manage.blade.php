...
@section('title') {{ 'ক্যাটাগরি ম্যানেজ' }} @endsection

@section('content')

    @component('components.breadcrumb')
        @slot('li_1') ক্যাটাগরি ম্যানেজ করুন @endslot
        @slot('title') ক্যাটাগরি ম্যানেজ @endslot
    @endcomponent
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary">
                    <h2 class="card-title text-white">ক্যাটাগরি লিস্ট</h2>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if ($category->childs()->count() > 0 )
                                    ...
                                    @include('Backend.Admin.category.subcategoriestree', ['subcategories' => $category->childs, 'parent' => $category->name])
                            ...
                            data-bs-target="#Notice{{ $category->id }}"> <span><i class="mdi mdi-eye"></i></span> </a> &nbsp;
                                    <div class="modal fade" id="Notice{{ $category->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
                                                ...
                                                <div class="modal-body">
                                                    <table class="table table-responsive">
                                                        <tr>
                                                            <th>নাম</th>
                                                            <td>:</td>
                                                            <td> <h4 class="text-success">{{ $category->name }}</h4> </td>
                                                        </tr>
                                                        <tr>
                                                            <th>বিবরণ</th>
                                                            <td>:</td>
                                                            <td> <span class="d-block" style="white-space:normal;">{{ $category->cat_desc }}</span> </td>
                                                        </tr>
                                                        <tr>
                                                            <th>সাব ক্যাটাগরি</th>
                                                            <td>:</td>
                                    ...
                                    <a href="{{ route('category.edit', $category->id) }}" title="edit" class="text-info"> <span><i class="mdi mdi-lead-pencil"></i></span> </a> &nbsp;
                                    <a href="javascript:void(0)" onclick="deleteConfirmation('{{$category->id}}')" class="text-danger"> <span><i class="mdi mdi-delete"></i></span> </a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
