                    ...
                    <form action="{{ route('category.store') }}" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="row">
                            <div class="form-group mb-3 col-4">
                                ...
                                <input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" placeholder="ক্যাটাগরি নাম" required>
                            ...
                            <div class="form-group mb-3 col-4">
                                ...
                                <select class="form-select" name="parent_category">
                                    ...
                                    @if ($category->childs()->count() > 0 )
                                        ...
                                        @include('Backend.Admin.category.subcategories', ['subcategories' => $category->childs, 'parent' => $category->name])
                            ...
                            <div class="form-group mb-3 col-12">
                                ...
                                <textarea name="cat_desc" class="form-control" id="cat_desc" cols="5" rows="5" required>{{ old('address') }}</textarea>
                                <div class="valid-feedback">
                                    ঠিক আছে
                                </div>
                            </div>
