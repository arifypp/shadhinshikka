...
@section('title') {{ 'শিক্ষার্থী ভিউ' }} @endsection

@section('content')

@component('components.breadcrumb')
    @slot('li_1') শিক্ষার্থী ভিউ @endslot
    @slot('title') শিক্ষার্থী তথ্য  @endslot
@endcomponent
                ...
                <div class="card-body">
                    <div class="card-inner-text">
                        ...
                        <div class="teacher-details">
                            ...
                            <a href="{{ route('student.manage') }}" class="btn btn-dark">পেছনে</a>
                            @if( $user->status == 1 )
                            <a href="{{ route('student.status', $user->id) }}" class="btn btn-danger suspend">সাসপেন্ড করুন</a>
                            @else
                            <a href="{{ route('student.status', $user->id) }}" class="btn btn-info suspend">সক্রিয় করুন</a>
                            @endif
                            </div>
                        </div>
                    </div>
