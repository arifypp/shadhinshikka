...
@section('title') {{ 'শিক্ষার্থী তৈরি করুন' }} @endsection

@section('content')

    @component('components.breadcrumb')
        @slot('li_1') শিক্ষার্থী সেটিং @endslot
        @slot('title') শিক্ষার্থী তৈরি করুন  @endslot
    @endcomponent
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('student.store') }}" method="post" id="teacherRgter" class="needs-validation" enctype="multipart/form-data" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <h4>শিক্ষার্থীর বেসিক তথ্য</h4><hr> 
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="teacherId" class="form-label">শিক্ষার্থী আইডি </label>
                                    <input type="text" name="teacherId" value="SS-{{ rand('1', 100000) }}" class="form-control" id="teacherId" placeholder="দিন - মাস - বছর" readonly >
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
