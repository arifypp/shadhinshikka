...
@section('title') {{ 'নোটিশ তৈরি' }} @endsection

@section('content')

    @component('components.breadcrumb')
        @slot('li_1') নোটিশ তৈরি করুন @endslot
        @slot('title') নোটিশ তৈরি @endslot
    @endcomponent
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('notice.store') }}" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="title" value="{{ old('title') }}" id="title" class="form-control" placeholder="Enter Title" required>
                            <div class="valid-feedback">
                                ঠিক আছে
                            </div>
                            @error('title')
                        ...
                        <div class="form-group mb-3">
                            <button type="submit" class="btn btn-primary" id="submit"> নোটিশ সেন্ড করুন </button>
                        </div>
                    </form>
                </div>
            </div>
